...
| R-010 Staff authentication, 2FA, RBAC, journal scopes | PRD 3, 10, 16; owner request 2026-09-09 | API auth/security, admin | Existing production login persistence is browser-verified; new step-up reset/password APIs, mandatory re-enrollment, session revocation, authorization/audit integration and browser tests await exact-SHA runtime/deployed verification | TESTED |
