...
2. Identity and localization: Telegram author identity, consent, administrator local auth/TOTP/session, `AUTHOR`/`ADMIN` permission matrix, locale selection and parity gates.
...
9. Complete admin surfaces: dashboard, articles, journals/requirements, standalone reviewers, Telegram content/contacts, notifications, administrators and settings; audit/privacy remain backend controls.
